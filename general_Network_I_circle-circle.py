...
Utility= alpha*(soln[q1]) - ((soln[q1])**2)/2 - s*((soln[q1])*(soln[q8])) - s*((soln[q1])*(soln[q2])) - ((p1)*(soln[q1])) + alpha*(soln[q2]) - ((soln[q2])**2)/2 - s*((soln[q2])*(soln[q1])) - s*((soln[q2])*(soln[q3])) - ((p2)*(soln[q2])) + alpha*(soln[q3]) - ((soln[q3])**2)/2 - s*((soln[q3])*(soln[q2])) - s*((soln[q3])*(soln[q4])) - ((p3)*(soln[q3])) + alpha*(soln[q4]) - ((soln[q4])**2)/2 - s*((soln[q4])*(soln[q3])) - s*((soln[q4])*(soln[q5])) - ((p4)*(soln[q4])) + alpha*(soln[q5]) - ((soln[q5])**2)/2 - s*((soln[q5])*(soln[q4])) - s*((soln[q5])*(soln[q6])) - ((p5)*(soln[q5])) + alpha*(soln[q6]) - ((soln[q6])**2)/2 - s*((soln[q6])*(soln[q5])) - s*((soln[q6])*(soln[q7])) - ((p6)*(soln[q6]))  + alpha*(soln[q7]) - ((soln[q7])**2)/2 - s*((soln[q7])*(soln[q6])) - s*((soln[q7])*(soln[q8])) - ((p7)*(soln[q7])) + alpha*(soln[q8]) - ((soln[q8])**2)/2 - s*((soln[q8])*(soln[q7])) - s*((soln[q8])*(soln[q1])) - ((p8)*(soln[q8])) 
...
plt.title('Network I | b=0.5')
plt.xlabel('γ')
plt.ylabel('Welfare')
plt.text(0.47, f_max_val -8.5, f"Maximum Welfare: {f_max_val:.2f} at γ={n_max:.2f}", ha='center')
plt.show()