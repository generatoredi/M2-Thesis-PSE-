...
P1 = alpha - s*q5 - q1 - s*q2 - s*q3 - s*q4
P2 = alpha - s*q6 - q2 - s*q1 - s*q3 - s*q4
P3 = alpha - s*q7 - q3 - s*q1 - s*q2 - s*q4
P4 = alpha - s*q8 - q4 - s*q1 - s*q2 - s*q3
P5 = alpha - s*q1 - q5
P6 = alpha - s*q2 - q6
P7 = alpha - s*q3 - q7
P8 = alpha - s*q4 - q8
...
Utility= alpha*(soln[q5]) - ((soln[q5])**2)/2 - s*((soln[q5])*(soln[q1])) - ((p5)*(soln[q5])) + alpha*(soln[q6]) - ((soln[q6])**2)/2 - s*((soln[q6])*(soln[q2])) - ((p6)*(soln[q6])) + alpha*(soln[q7]) - ((soln[q7])**2)/2 - s*((soln[q7])*(soln[q3])) - ((p7)*(soln[q7])) + alpha*(soln[q8]) - ((soln[q8])**2)/2 - s*((soln[q8])*(soln[q4])) - ((p8)*(soln[q8])) + alpha*(soln[q1]) - ((soln[q1])**2)/2 - s*((soln[q1])*(soln[q5])) - s*((soln[q1])*(soln[q2])) - s*((soln[q1])*(soln[q3])) - s*((soln[q1])*(soln[q4])) - ((p1)*(soln[q1])) + alpha*(soln[q2]) - ((soln[q2])**2)/2 - s*((soln[q2])*(soln[q6])) - s*((soln[q2])*(soln[q1])) - s*((soln[q2])*(soln[q3])) - s*((soln[q2])*(soln[q4])) - ((p2)*(soln[q2]))  + alpha*(soln[q3]) - ((soln[q3])**2)/2 - s*((soln[q3])*(soln[q7])) - s*((soln[q3])*(soln[q1])) - s*((soln[q3])*(soln[q2])) - s*((soln[q3])*(soln[q4])) - ((p3)*(soln[q3])) + alpha*(soln[q4]) - ((soln[q4])**2)/2 - s*((soln[q4])*(soln[q8])) - s*((soln[q4])*(soln[q1])) - s*((soln[q4])*(soln[q2])) - s*((soln[q4])*(soln[q3]))  - ((p4)*(soln[q4])) 
...
plt.title('Network G | b=0.8')
plt.xlabel('γ')
plt.ylabel('Welfare')
plt.text(0.47, f_max_val -110.5, f"Maximum Welfare: {f_max_val:.2f} at γ={n_max:.2f}", ha='center')
plt.show()